class Chess {
     ...
     * @param mapMaker
     */
    constructor(currentColumn = null, currentRow = null) {
        this.columns = ["A", "B", "C", "D", "E", "F", "G", "H"];
        this.currentColumnIndex = currentColumn === null ? null : this.getColumnIdx(currentColumn);
        this.currentRow = currentRow === null ? null : +currentRow;
        this.possibleMove = [];
    }
